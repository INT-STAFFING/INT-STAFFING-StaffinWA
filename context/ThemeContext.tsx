...
export const defaultTheme: Theme = {
    // Intellera Design System — palette light
    light: {
        primary: '#06414a',
        onPrimary: '#ffffff',
        primaryContainer: '#bed6e1',
        onPrimaryContainer: '#06414a',
        secondary: '#0a5560',
        onSecondary: '#ffffff',
        secondaryContainer: '#d8e6ec',
        onSecondaryContainer: '#06414a',
        tertiary: '#9f95be',
        onTertiary: '#ffffff',
        tertiaryContainer: '#e8e4f0',
        onTertiaryContainer: '#3d3357',
        error: '#9f3c59',
        onError: '#ffffff',
        errorContainer: '#f3dbe3',
        onErrorContainer: '#5c1f33',
        background: '#fafaf7',
        onBackground: '#06414a',
        surface: '#ffffff',
        onSurface: '#06414a',
        surfaceVariant: '#eaf0f2',
        onSurfaceVariant: '#5c7378',
        outline: '#cdd9db',
        outlineVariant: '#e2e8e9',
        shadow: '#000000',
        scrim: '#000000',
        inverseSurface: '#06414a',
        inverseOnSurface: '#fafaf7',
        inversePrimary: '#fae650',
        surfaceContainerLowest: '#ffffff',
        surfaceContainerLow: '#fafaf7',
        surfaceContainer: '#f4f4ef',
        surfaceContainerHigh: '#eeede6',
        surfaceContainerHighest: '#e8e7df',
    },
    // Intellera Design System — palette dark (variante teal scura)
    dark: {
        primary: '#fae650',
        onPrimary: '#06414a',
        primaryContainer: '#0a5560',
        onPrimaryContainer: '#bed6e1',
        secondary: '#bed6e1',
        onSecondary: '#06414a',
        secondaryContainer: '#0a5560',
        onSecondaryContainer: '#d8e6ec',
        tertiary: '#c4bbdc',
        onTertiary: '#2e2545',
        tertiaryContainer: '#4a4063',
        onTertiaryContainer: '#e8e4f0',
        error: '#e8a0b4',
        onError: '#5c1f33',
        errorContainer: '#7a2c44',
        onErrorContainer: '#f3dbe3',
        background: '#06262b',
        onBackground: '#eaf2f3',
        surface: '#06262b',
        onSurface: '#eaf2f3',
        surfaceVariant: '#1e3b40',
        onSurfaceVariant: '#b0c4c8',
        outline: '#4a6469',
        outlineVariant: '#1e3b40',
        shadow: '#000000',
        scrim: '#000000',
        inverseSurface: '#eaf2f3',
        inverseOnSurface: '#06262b',
        inversePrimary: '#06414a',
        surfaceContainerLowest: '#041c20',
        surfaceContainerLow: '#0a2e33',
        surfaceContainer: '#0e3338',
        surfaceContainerHigh: '#143c42',
        surfaceContainerHighest: '#1a454c',
    },
    toastPosition: 'top-center',
    toastSuccessBackground: '#06414a',
    toastSuccessForeground: '#fae650',
    toastErrorBackground: '#9f3c59',
