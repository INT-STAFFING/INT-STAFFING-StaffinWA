    ...
    <div className="bg-card dark:bg-dark-card rounded-lg shadow p-6 flex flex-col">
        ...
        <div className="mt-6 text-right">
            <button
                ...
                className="inline-flex items-center justify-center px-4 py-2 bg-primary text-dark-foreground dark:text-dark-sidebar-foreground font-semibold rounded-md shadow-sm hover:bg-primary-darker disabled:bg-primary/50 disabled:cursor-not-allowed transition-colors duration-200"
            >
                {isExporting ? (
                    <>
