...
const colorLabels: { [key in keyof Theme]: string } = {
    ...
    headerBackground: 'Header Background (Light)',
    headerForeground: 'Header Text (Light)',
    headerBorder: 'Header Border (Light)',
    sidebarBackground: 'Sidebar Background (Light)',
    sidebarForeground: 'Sidebar Text (Light)',
    sidebarMuted: 'Sidebar Muted (Light)',
    sidebarBorder: 'Sidebar Border (Light)',
    sidebarActiveBackground: 'Sidebar Active Background (Light)',
    sidebarActiveForeground: 'Sidebar Active Text (Light)',
    ...
    darkHeaderBackground: 'Header Background (Dark)',
    darkHeaderForeground: 'Header Text (Dark)',
    darkHeaderBorder: 'Header Border (Dark)',
    darkSidebarBackground: 'Sidebar Background (Dark)',
    darkSidebarForeground: 'Sidebar Text (Dark)',
    darkSidebarMuted: 'Sidebar Muted (Dark)',
    darkSidebarBorder: 'Sidebar Border (Dark)',
    darkSidebarActiveBackground: 'Sidebar Active Background (Dark)',
    darkSidebarActiveForeground: 'Sidebar Active Text (Dark)',
};
