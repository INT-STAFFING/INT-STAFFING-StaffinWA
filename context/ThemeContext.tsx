...
export const defaultTheme: Theme = {
    ...
    light: {
        ...
        inverseOnSurface: '#e7eef0',
        inversePrimary: '#fae650',
        surfaceContainerLowest: '#ffffff',
        surfaceContainerLow: '#ffffff',
        surfaceContainer: '#f7fafb',
        surfaceContainerHigh: '#eef3f4',
        surfaceContainerHighest: '#e3ebed',
    },
    ...
    dark: {
        ...
        surfaceContainerLowest: '#06262b',
        surfaceContainerLow: '#14454e',
        surfaceContainer: '#184b54',
        surfaceContainerHigh: '#1f535d',
        surfaceContainerHighest: '#285c66',
    },
